...
If the plugin settings panel shows a server configuration error with the **bypassing_apache** code, it means a problem with Nginx Reverse Proxy fof static files or Nginx Caching fof static files.
